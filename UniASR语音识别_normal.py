    ...
    with gr.Blocks(
        ...
        with gr.Row():
            with gr.Column(variant='panel'):
                ...
                inp_url = gr.Textbox(lines=1,placeholder='https://', label='输入音频链接',show_label=True,show_copy_button=True,
                ...
                inp0.change(audio_source,[inp0, inp_url],  [inp1, inp_url])
            ...
            with gr.Column(variant='panel'):
                out0 = gr.Textbox(lines=6,placeholder='语音识别为:', label='识别文本......',show_label=True,show_copy_button=True)
